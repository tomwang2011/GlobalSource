...
public class Module {
	...
	public Module(
		...
		List<JarDependency> moduleJarDependencies) {
		...
		_moduleJarDependencies = moduleJarDependencies;
	}
	...
	public List<JarDependency> getModuleJarDependencies() {
		if (_moduleJarDependencies != null) {
	...
	public String getModuleName() {
		Path moduleNamePath = _modulePath.getFileName();

		return moduleNamePath.toString();
	}
